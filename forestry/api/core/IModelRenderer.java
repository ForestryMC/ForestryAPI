...
public interface IModelRenderer {
	...
	boolean renderStandardBlock(Block block, BlockPos pos, ISprite[] textures);
	...
	void renderFaceXNeg(BlockPos pos, ISprite lights);
	
	void renderFaceYNeg(BlockPos pos, ISprite lights);

	void renderFaceZNeg(BlockPos pos, ISprite lights);

    void renderFaceYPos(BlockPos pos, ISprite lights);

	void renderFaceZPos(BlockPos pos, ISprite lights);

	void renderFaceXPos(BlockPos pos, ISprite lights);
	
	void setNormal(float x, float y, float z);

	void setOverrideBlockTexture(ISprite sprite);
