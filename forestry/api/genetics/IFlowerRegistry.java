...
public interface IFlowerRegistry {
	...
	/**
	 * Registers a not plantable flower, but bees accept them.
	 * 
	 * @param ItemStack Flower 
	 * @param flowerTypes See {@link forestry.api.apiculture.FlowerManager}.FlowerTypeXXX
	 */
	void registerAccecptableFlower(ItemStack is, String... flowerTypes);
	 ...
	 * @param flowerTypes See {@link forestry.api.apiculture.FlowerManager}.FlowerTypeXXX
	 */
	void registerPlantableFlower(ItemStack is, double weight, String... flowerTypes);
